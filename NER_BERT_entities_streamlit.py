#!/usr/bin/env python3
"""
Streamlit Entity Linker Application with the bert-base-NER model

A web interface for entity extraction and linking using the bert-base-NER model.
...
class StreamlitEntityLinker:
    ...
    def render_header(self):
        ...
        st.header("From Text to Linked Data using the bert-base-NER model")
        st.markdown("**Extract and link named entities using the bert-base-NER model**")
        ...
        <div style="background-color: white; padding: 20px; border-radius: 10px; margin: 20px 0; border: 1px solid #E0D7C0;">
            <div style="text-align: center; margin-bottom: 20px;">
                ...
                <div style="background-color: #9fd2cd; padding: 10px; border-radius: 5px; display: inline-block; margin: 5px;">
                     <strong>bert-base-NER model + Smart Patterns</strong>
                </div>
                <div style="margin: 10px 0;">⬇️</div>
    ...
    def process_text(self, text: str, title: str):
        ...
        with st.spinner("Processing text with the bert-base-NER model..."):
            try:
    ...
    def render_export_section(self, entities: List[Dict[str, Any]]):
        ...
        with col1:
            ...
            json_data = {
                ...
                "processingMethod": "bert-base-NER model + Smart Patterns",
                "modelInfo": {
